...
import qualified PP.IndentationMonad as IndentationMonad
...
data Token
    = Block Consistency (Maybe String) (Maybe String) (Maybe String) [Token]
    | NoIndentBlock Consistency (Maybe String) (Maybe String) (Maybe String) [Token]
                ...
                _
                    ...
                    | otherwise ->
                        IndentationMonad.write (fromMaybe "" left_if_single_line)
                            >> intercalate_delim True (map render' items)
                            >> IndentationMonad.write (fromMaybe "" right_if_single_line) -- true if first
            where
